...
| TZ-235 | Конструктор v2 UX-апгрейд (16 sub-TZ, 7 waves, ~140-180h) — planning doc. **Wave 1 R2 (BuilderStateService: 16 handlers extraction) DONE 2026-07-30** (commit 3633b9c). **Wave 1 R3 (page.ts dual-source cleanup: -607 lines) DONE 2026-07-30** (commit 0cb8e60). **Wave 1 R2-extra (page.ts forkJoin/loadBlocks fix) DONE 2026-07-30** (commit included). **Wave 2 R1 (block-renderer-state.service.ts: 1484 → 941 lines, -37%) DONE 2026-07-30** (commit 7a27443). Per-instance service via `providers:`; template syntax unchanged via signal aliasing. Pending sub-waves: TZ-235.D (group drag), TZ-235.E (undo/redo), TZ-235.G (scroll-aware drag). | frontend/src/app/pages/doc-constructor/builder/* | TZ-232.J |
