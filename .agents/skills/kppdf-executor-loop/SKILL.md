...
Это **не** выбор и **не** gate. PO часто **AFK** — см. `docs/agents/CLAUDE-UNATTENDED.md`.

Запрещено mid-wave (чат):
- «продолжать? / ок? / сделать commit? / можно push? / архивировать?»
- Plan Mode + ждать approve плана
- Пауза «пока PO не подтвердит следующий TZ» внутри уже выданной WAVE
