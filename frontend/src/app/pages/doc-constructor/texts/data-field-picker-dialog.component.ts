...
import type { DataSourceDescriptor, FieldDescriptor } from '../../../shared/services/pi-registry.service';
...
@Component({
                  ...
                  @for (src of group.sources; track src.key) {
                    ...
                    >
                      ...
                      <span class="dfpd-source-meta">
                        <span class="dfpd-source-count">{{ src.fields.length }} {{ fieldWord(src.fields.length) }}</span>
          ...
          <div class="dfpd-fields-panel">
            @if (selectedSource(); as src) {
              <div class="dfpd-fields-head">
                <button type="button" class="dfpd-back" (click)="backToSources()">← Все источники</button>
  ...
  styles: [`
    ...
    .dfpd-source-row:last-child { border-bottom: none; }
