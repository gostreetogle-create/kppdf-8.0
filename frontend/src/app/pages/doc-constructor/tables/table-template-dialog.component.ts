...
@Component({
                ...
                >
                  @for (col of columnsArray.controls; track $index; let i = $index) {
                    <tr [formGroupName]="i" cdkDrag [cdkDragData]="col" class="ttd-tr">
                      ...
                      <td class="ttd-td">
                        <input
                          class="ttd-cell-input font-mono"
                          formControlName="key"
                          placeholder="article"
                        />
                      </td>
                      ...
                      <td class="ttd-td">
                        <input
                          class="ttd-cell-input font-mono text-center"
                          type="number"
                      ...
                      <td class="ttd-td">
                        <div class="ttd-align-group">
                          <button
                            ...
                            (click)="col.controls.align.setValue('left')"
                          >
                            &#x2261;
                          </button>
                          <button
                            ...
                            (click)="col.controls.align.setValue('center')"
                          >
                            &#x2261;
                          </button>
                          <button
                            ...
                            (click)="col.controls.align.setValue('right')"
                          >
                            &#x2261;
                          </button>
                        </div>
                      ...
                      <td class="ttd-td ttd-td--actions">
                        <div class="ttd-col-actions">
                          ...
                          <button
                            type="button"
                            class="ttd-icon-btn ttd-icon-btn--danger"
              ...
              <div class="ttd-preview-body">
                <div class="ttd-preview-doc">
                  ...
                  <div class="ttd-preview-table">
                    <div
                      class="ttd-preview-row ttd-preview-row--head"
                      [style.grid-template-columns]="previewGrid(preview.columns)"
                    >
                      @for (col of preview.columns; track col.key) {
                        <div class="ttd-preview-cell eyebrow" [style.text-align]="col.align">
                          {{ col.label }}
                        </div>
                      }
                    </div>
                    @for (row of preview.rows; track $index) {
                      <div
                        class="ttd-preview-row"
                        [style.grid-template-columns]="previewGrid(preview.columns)"
                      >
                        @for (cell of row; track $index; let ci = $index) {
                          <div
                            class="ttd-preview-cell"
  ...
  styles: [
    `
      ...
      .ttd-icon-btn:disabled {
        opacity: 0.3;
        cursor: not-allowed;
      }
      .ttd-icon-btn:disabled:hover {
        background: transparent;
        color: var(--color-muted-foreground-strong);
        border-color: transparent;
      }
      .ttd-icon-btn--danger:hover {
      ...
      .ttd-preview-doc-head {
        padding: 6px;
      }
      .ttd-preview-doc-head h3 {
        margin: 0;
        font-size: 14px;
      }
      .ttd-preview-table {
