...
import { ProductModulesService, ProductModule } from '../../shared/services/pi-product-modules.service';
...
describe('ModulesPage', () => {
  ...
  it('shows empty state when no modules', async () => {
    ...
    const comp = fixture.componentInstance as unknown as { data: () => ProductModule[]; total: () => number };
