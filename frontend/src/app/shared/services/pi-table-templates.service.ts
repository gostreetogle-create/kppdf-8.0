...
export class TableTemplatesService {
  ...
  list(
    params: TableTemplateListParams = {},
  ): Observable<SilentResult<TableTemplateListResponse>> {
    ...
    return silentGet<TableTemplate[]>(
      this.http,
      `${this.baseUrl}/table-templates`,
      { params: httpParams },
    ).pipe(
      map((res) => {
  ...
  findById(id: string): Observable<SilentResult<TableTemplate>> {
    return silentGet<TableTemplate>(
      this.http,
      `${this.baseUrl}/table-templates/${id}`,
    );
  }
  ...
  preview(id: string): Observable<SilentResult<string>> {
    return silentWrap(this.http.get(`${this.baseUrl}/table-templates/${id}/preview`, { responseType: 'text' }));
  }

  create(payload: Partial<TableTemplate>): Observable<SilentResult<TableTemplate>> {
    return silentPost<TableTemplate>(
      this.http,
      `${this.baseUrl}/table-templates`,
      payload,
    );
  ...
  update(
    id: string,
    payload: Partial<TableTemplate>,
  ): Observable<SilentResult<TableTemplate>> {
    return silentPatch<TableTemplate>(
      this.http,
      `${this.baseUrl}/table-templates/${id}`,
      payload,
    );
