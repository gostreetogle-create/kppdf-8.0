...
| `/home` (NX) | home.page.md | **WAVE-NX-HOME DONE** (route/hub/chips) · **TZ-NX-HOME-BREADCRUMB-EDIT-CTA READY** eyebrow «Главная» + CTA «Редактировать заказ» в hub |
...
| `/orders` (NX) | orders.page.md | **WAVE-NX-SALES-CANON S30–S34 DONE** — thin list route with loading/error/empty states; карточка/прямой create/оплата дальше по chain; без stub-КП · **TZ-NX-HUB-02 DONE** list affordance ▸ + icon «карточка» (`WAVE-NX-HUB-TABLE-PARITY`) |
...
| `/proposals` | **proposals.page.md** | **FORMS-316 READY**; **SALES-313 DONE** family; **NX KP Family S40–S48 DONE** (types/API/hide variants/expand/attach/sync/studio/convert guard/operator docs) · S47 `2cdf013e` |
