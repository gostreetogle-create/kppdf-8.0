...
| `/` , `/desk` | **manager-desk.page.md** | **401/405/406 DONE**; **402/412/403/413/410/411 DONE**; **407 DONE** view=gantt/combine stub; **404 DONE** deep-link студии + «На стол»; **408 DONE** DeskNote (BE+FE); **414 DONE** RouterLink + stale notes + `[activeId]=view()`; **415 DONE** GET orderId + PATCH/DELETE author; **416** tray production `from=desk`; **TZ-DESK-418 DONE** delete заказа со стола с confirm; **TZ-DESK-423 DONE** операторский tray |
