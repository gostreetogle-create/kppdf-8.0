...
| `/proposals/create` | **proposals-create.page.md** | editor 359–367 DONE; **370–372 DONE**; **UX-318** columns checkbox menu stay-open (READY FOR REVIEW); **UX-316 READY** edit→builder+return; **368 READY** output gates; **320** PARK; view-ready — идея |
