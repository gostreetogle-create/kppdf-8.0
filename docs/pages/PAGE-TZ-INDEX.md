...
| `/proposals` | **proposals.page.md** | **FORMS-316 READY**; **SALES-313 DONE** family; **NX S20** «В студии»; **S37 DONE** convert accepted → заказ; **S42 DONE** variant-строки скрыты + badge «Семья» на master |
