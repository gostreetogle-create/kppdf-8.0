...
| `/orders` (NX) | orders.page.md | **WAVE-NX-SALES-CANON S30–S34 DONE** — thin list route with loading/error/empty states; карточка/прямой create/оплата дальше по chain; без stub-КП · **TZ-NX-HUB-02 READY** list affordance ▸ + icon «карточка» (`WAVE-NX-HUB-TABLE-PARITY`) |
