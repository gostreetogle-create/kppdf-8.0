...
| `/orders` (NX) | orders.page.md | **WAVE-NX-SALES-CANON S30–S34 DONE** — thin list route with loading/error/empty states; карточка/прямой create/оплата дальше по chain; без stub-КП |
...
| `/warehouses` | warehouses.page.md | legacy CRUD reference; **WAVE-NX-WAREHOUSE W1 DONE** live thin name+active+description (type/zones hidden) |
