...
| `/orders` | orders.page.md | ORDERS-*; **303.1** deep-link `?q=`; **ORDERS-HUB-301** DONE; **HUB-302 DONE**; **HUB-303 DONE** supply/production/docs expand; **HUB-304 DONE** readiness/warehouse/shipping stub; **ORDERS-336 DONE** form Save productId + default Site + freeze |
