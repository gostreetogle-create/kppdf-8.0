...
| `/design`, `/design/combine`, `/supply`, `/shipping` | **design.page.md**; **design-combine.page.md**; supply.page.md; shipping.page.md; **design/shipping OPS-307 DONE** | **NAV-301** design stub; **NAV-303 DONE** Комбайн → `/design/combine` (Проект); **supply** live (SUPPLY-301); **shipping** stub; **ORDERS-HUB-303 DONE** supply `?orderId=`; **HUB-304 DONE** hub shipping stub link; **UX-342 DONE** drop dead pager total; **SWEEP-401** write-path на combine |
| `/` , `/dashboard` | **dashboard.page.md** | **NAV-303 DONE** home = stub «Обзор» (`DashboardStatsPage`); полные виджеты → **TZ-DASHBOARD-401**; **UX-331 DONE** shell brand = home chip; Канбан переехал на `/design/combine` |
