...
| `/design`, `/design/combine`, `/supply`, `/shipping` | **design.page.md**; **design-combine.page.md**; supply.page.md; shipping.page.md | **NAV-303/305** Комбайн в Проект; **COMBINE-401…411** boardLane/product-rows; **412** fuse; **414** name→expand / pencil-edit; метод [`combine-product-row-kanban.md`](../methods/combine-product-row-kanban.md); **supply** live; **shipping** stub; **SWEEP-401** ship |
