...
**Updated:** 2026-08-16 (TZ-UX-342 DONE KP rail + dead totals; WAVE pagination #1–#3 DONE)
...
| Route | Page doc | TZs |
|-------|----------|-----|
| `/materials` | materials.page.md | MATERIALS-*; **CATALOG-301** BE DONE; **FE поля 301 = TZ-CATALOG-316**; **CATALOG-UI-301** Group Chip; **UX-314** PAGE_SIZE=10; **UX-341 DONE** grid→pi-pagination; **CATALOG-373 DONE** grid + filters-rail (parity products, `pi-materials-view-mode`); **CATALOG-375 DONE** list expandable preview (как products/modules); **TZ-UI-PHOTO-343 DONE** shared dropzone file/drag/Ctrl+V; **UX-328 DONE** chrome page-tools (mirror UX-326; no w-12 rail) |
...
| `/design`, `/design/combine`, `/supply`, `/shipping` | **design.page.md**; **design-combine.page.md**; supply.page.md; shipping.page.md | **NAV-303/305** Комбайн в Проект; **COMBINE-401…405** boardLane изделий (v1); **406–408** modules/gate PARK; **supply** live; **shipping** stub; **SWEEP-401** ship |
