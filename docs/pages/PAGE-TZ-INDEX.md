...
| Route | Page doc | TZs |
|-------|----------|-----|
| `/materials` | materials.page.md | MATERIALS-*, **UX-305 DONE** |
...
| Route | Page doc | TZs |
|-------|----------|-----|
| `/inventory` | inventory-dashboard.page.md | **UX-301 DONE** |
| `/storage-items` | storage-items.page.md | **UX-301 DONE**, **UX-305 DONE**, MATERIALS-308 |
