...
| `/` , `/dashboard` | **dashboard.page.md** | DASHBOARD-400 Канбан; **TZ-SWEEP-401 READY** (write-path ship/cancel, freeze vs drag, nav «Комбайн», item.status fallback); **UX-331 DONE** shell brand = home chip → Комбайн; **PRODUCTION-337** (цех без `draft`; Комбайн Черновики не трогаем) |
