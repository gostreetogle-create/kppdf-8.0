...
| `/design`, `/design/combine`, `/supply`, `/shipping` | **design.page.md**; **design-combine.page.md**; supply.page.md; shipping.page.md | **NAV-303/305** Комбайн в Проект; **COMBINE-401…408** boardLane/moduleLanes; **WAVE product-rows 409–410** (ряд=изделие, expand mini-kanban); **supply** live; **shipping** stub; **SWEEP-401** ship |
