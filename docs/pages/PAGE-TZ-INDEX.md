...
| `/production` | production-cockpit.page.md | **300** Lego; **303 DONE**; **303.1 READY** hotfix+`?q=`; **STUDIO-A–D** chrome PASS; **WAVE-PRODUCTION-GANTT-RESIZE**: **309/311/312/313 DONE**; parked **308/310**; drawings **DRAWINGS-301**; 304–307 later; **ORDERS-HUB-303 DONE** `?orderId=` |
