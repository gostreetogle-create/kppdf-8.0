...
| `/design`, `/supply`, `/shipping` | supply.page.md; shipping.page.md; **design/shipping OPS-307 DONE** | **NAV-301** design stub; **supply** live (SUPPLY-301); **shipping** stub; **ORDERS-HUB-303 DONE** supply `?orderId=`; **HUB-304 DONE** hub shipping stub link; **UX-342 DONE** drop dead pager total |
| `/` , `/dashboard` | **dashboard.page.md** | DASHBOARD-400 Канбан; **TZ-SWEEP-401 READY** (write-path ship/cancel, freeze vs drag, nav «Комбайн», item.status fallback); **UX-331 DONE** shell brand = home chip → Комбайн |
