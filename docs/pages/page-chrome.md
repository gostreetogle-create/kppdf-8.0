...
- **Позиция:** ← → стоят **в вертикальных полях** слева/справа от колонки
  `pi-page-frame` (1400px), **у внешней грани колонки** (gap ≈8–16px), не у края
  окна. TZ-UX-320 (`left/right: 64px` = линия padding шапки) — interim; PO visual
  не принял. Целевой канон: **TZ-UX-321** —
  `left/right: max(8px, calc(50% - 700px - 48px))`.
...
_Создано: 2026-08-07. Обновлено: 2026-08-15 (TZ-UX-320)._
