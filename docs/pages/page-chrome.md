...
## Системные ← → в полях (TZ-UX-317 + TZ-UX-320, канон 2026-08-12)
...
- **Позиция (TZ-UX-320):** ← → стоят **в вертикальных полях** слева/справа от
  колонки контента, на **линии бокового отступа шапки** (`left/right: 64px` —
  padding `pi-edge-bleed` на ≥1024px), не у края окна (не `14px`).
