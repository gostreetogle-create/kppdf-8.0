...
## Вывод КП (TZ-SALES-345 → 367)

- Из студии: правый rail **Вывод** (`data-test="kp-create-toggle-output"`) → overlay: **Печать** · **PDF** · **Сохранить в архив документов** (Печать первая). Перед выводом дожимается автосохранение.
