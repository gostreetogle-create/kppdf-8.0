...
- 339: «Сохранить КП» находится в верхней строке студии; после выбора шаблона и нашей фирмы draft сохраняется автоматически с debounce, а F5 восстанавливает товары и шаблон из Quotation.
