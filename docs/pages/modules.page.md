...
_Создано: 2026-07-19. Обновлено: 2026-09-07 (TZ-NX-PHOTO-P3: рамка фото — dropzone-editor (contain/cover + drag-pan) → `PATCH /photos/:id/frame`; TZ-NX-PHOTO-P1: фото в форме модуля через `@kppdf/ui/photo` — файл/drag/Ctrl+V, ★ главное = `mainPhotoId`; ранее TZ-UX-327 chrome page-tools)._
