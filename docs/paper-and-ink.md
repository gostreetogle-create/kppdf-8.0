...
<div class="mt-form-row">label below</div>
<!-- 8px -->
<div class="mt-section">section below</div>
<!-- 24px -->
```
...
## Light theme surface ladder (TZ-UI-LIGHT-330)

The light theme uses a calm graphite canvas and a clear elevation ladder: `paper` is the page canvas, `paper-raised` is used for headers, cards, dialogs, dropdowns and controls, and `paper-2` is reserved for hover, zebra and recessed surfaces. Decorative `rule` hairlines remain quiet; use `rule-strong` for input, select and button contours.

| Level          | Token                  | Role                                             |
| -------------- | ---------------------- | ------------------------------------------------ |
| Canvas         | `--color-paper`        | Main page background                             |
| Raised         | `--color-paper-raised` | Header, card, dialog, dropdown and field surface |
| Hover/recessed | `--color-paper-2`      | Hover, zebra and recessed surface                |
