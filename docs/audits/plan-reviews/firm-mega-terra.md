...
7. **Исправить устаревшую карту W5.** После SHOP-NORTH-B уже есть tree заказа, Sites/quick-create, реестр снабжения с confirm/explode, line-ready и soft materials gate. В W5 оставить реальные дыры: D7 stub-КП, module-ready D8, очередь проектировщика, shipping UI/partial shipment и витрину КП; не планировать повторные TZ на supply/line-ready.
...
6. **Приоритет W5 vs W3:** первым W5a — D7 stub-КП, затем module-ready/design queue; supply, line-ready и materials soft-gate уже не являются работой W5. Печать улучшает вид КП, но разрыв отчётности прямого заказа ломает ежедневный поток. Витрину КП и shipping не включать в этот ранний слой. Нужен вердикт PO.
...
| W5 | W5a перед W3: D7 stub-КП; далее module-ready, design queue, shipping UI, витрина КП | Не дублирует уже готовые order tree/Sites/supply/line-ready/soft gate и не становится монолитом sales north. |
...
- Таблица «есть vs дыры» обновлена по SHOP-NORTH-B: в W5 нет повторных supply/line-ready TZ, а W5a=D7 имеет отдельный контракт.
