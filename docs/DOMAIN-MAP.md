...
| `/studio`, `/studio/templates`, `/studio/:id` | `document-studio` | Chrome IA C1–C4: Документы / Шаблоны / Студия |
...
| `/shipping` | `shipping` | **WAVE-NX-SHIPPING S1 DONE**: live registry, `?orderId=` deep-link, create/dispatch/cancel/edit/add-doc dialogs |
