...
**TZ-UI-412** — DONE by `freebuff-1` (2026-08-22): remaining `text-[10px]` catalog micro-type in products/modules/materials raised to `text-[11px]`; archive `tasks/_archive/2026-08/TZ-UI-412.done.md`; SHA pending; gates FE tsc + scoped search PASS; deploy НЕ.
