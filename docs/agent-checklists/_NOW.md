...
**TZ-UI-414** — DONE by `freebuff-1` (2026-08-22): dashboard lane helper `text-[10px]` raised to `text-[11px]`; archive `tasks/_archive/2026-08/TZ-UI-414.done.md`; SHA pending; gates FE tsc + scoped search PASS; deploy НЕ.
