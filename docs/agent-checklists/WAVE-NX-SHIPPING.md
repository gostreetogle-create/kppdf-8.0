...
| S1 | L | Registry `/shipping` + nav + route | `tasks/_ready/nx-shipping/TZ-NX-SHIP-S1-REGISTRY.md` | READY |
| S2 | L | Hub tray READ shipments | `tasks/_ready/nx-shipping/TZ-NX-SHIP-S2-HUB-READ.md` | READY |
