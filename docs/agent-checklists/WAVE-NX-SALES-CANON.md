...
Status: **IN PROGRESS @ S37** · S30–S36 DONE · Doc Studio S16–S26 DONE
...
| 7 | [x] S36 ORDER-CREATE | `tasks/_archive/2026-09/TZ-NX-SALES-S36-ORDER-CREATE.done.md` | _push_ |
...
- S36 archive: `tasks/_archive/2026-09/TZ-NX-SALES-S36-ORDER-CREATE.done.md` · commit pushed (see chain row).
- S37 is the next unchecked chain row.
