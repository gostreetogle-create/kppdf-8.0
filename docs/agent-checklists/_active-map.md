...
**Updated:** 2026-08-08 · dual wave (desktop A + shop-north B)

## Checkpoint (wave #3 TZD-18 DONE)

- DONE: **TZD-23** · **TZD-26** · **TZD-18** (batch propose/confirm + cap 2000 + apply_plan chunks) — all on main
- IN PROGRESS A (desktop): TZD-19 → 27 → 28 → 29
- READY B (shop-north): SUPPLY-302 → ORDERS-304 → 305 → SALES-302 → FACT-303 → 304 → FORM-307
- NEXT A: claim **TZD-19** · `tasks/_backlog/desktop/`
