...
target_score: 98
blocked: none
last_phase: 326 — DONE / archived
last_tz: TZ-PRODUCTION-326
last_action: archive + lock created; root/active TZ-326 removed; docs/status synced
next_action: targeted commit + push TZ-326, then claim TZ-PRODUCTION-327
