...
| 02 | L | `tasks/TZ-NX-TEXT-CAT-NX-CRUD.md` | NX route `/dictionaries/text-block-categories` (dead nav fix); CRUD categories+subcats; Pi service mutate | READY after 01 |
