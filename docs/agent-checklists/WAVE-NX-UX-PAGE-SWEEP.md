...
| 08 | `/warehouses` | `tasks/PROMPT-CLAUDE-UX-08-warehouses.md` | **DONE** — audit `395b08fa`, FIX applied (P0 `pi-button-*` → `app-pi-button`) — ⚠️ 17 sibling files still affected, see audit |
