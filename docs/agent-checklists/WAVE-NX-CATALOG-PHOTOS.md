...
**Статус:** PARK (будущее) — не стартовать, пока занят `kppdf-web` (склад / supply FE / S45).  
**Audit:** `docs/audits/2026-09-05-catalog-photos-nx-audit.md`  
**Промпт:** `tasks/PROMPT-NX-CATALOG-PHOTOS.md`  
...
|---|------|-----|------|------|--------|
| P0 | L | TZ-NX-PHOTO-P0-DROPZONE-LIB | `tasks/_ready/nx-photos/TZ-NX-PHOTO-P0-DROPZONE-LIB.md` | — | PARK |
