...
|---|-------|------|--------|-----|------------|
| 01 | counterparties hub+icons | `tasks/_ready/nx-hub/counterparties/TZ-NX-HUB-01-counterparties.md` | IN_WORK | — | — |
| 02 | orders affordance+icons | `tasks/_ready/nx-hub/orders/TZ-NX-HUB-02-orders.md` | PENDING | — | — |
| 03 | supply dense+compact | `tasks/_ready/nx-hub/supply/TZ-NX-HUB-03-supply.md` | PENDING | — | — |
