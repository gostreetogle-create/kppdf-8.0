# Freebuff — один TZ: S39 CREATE-DOCTYPE
...
4. TZ SoT: `tasks/_ready/TZ-NX-DOCSTUDIO-S39-CREATE-DOCTYPE.md`
...
Коротко в чат: SHA + archive path. Жди следующий PROMPT (S37 smoke если ещё не был — см. INDEX порядок).
