# TZ-NX-UX-01-kit-forms-AUDIT: UX smell audit — `/kit/forms`
...
**CONFLICT KEYS:**  
`docs/audits/2026-09-09-nx-ux-kit-forms-audit.md` (create) ;  
`docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md` (row 01)

### Preflight Check Output
- **Context read:** `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`; registry gold `registry-detail-panel.component.ts`; page sources under `frontend-nx/.../pages/forms/**`
- **Key Constraints:** **NO product code** in this TZ. One page only: `/kit/forms`.
...
**Note:** Form primitives parity

---

## ЧТО ДЕЛАТЬ

1. Открой код страницы `/kit/forms` (не по памяти). При живом стенде — глазом UI.
2. Пройди чеклист T1–C1 из `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`.
3. Сравни с `/registries` expand + `pi-button` toolbar.
4. Напиши `docs/audits/2026-09-09-nx-ux-kit-forms-audit.md`:
...
5. Обнови WAVE row 01 audit status. Archive. **Не** правь product code.
