# TZ-NX-UX-07-supply-requests-AUDIT: UX smell audit — `/supply-requests`
...
**CONFLICT KEYS:**  
`docs/audits/2026-09-09-nx-ux-supply-requests-audit.md` (create) ;  
`docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md` (row 07)

### Preflight Check Output
- **Context read:** `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`; registry gold `registry-detail-panel.component.ts`; page sources under `frontend-nx/.../pages/supply/**supply-request**`
- **Key Constraints:** **NO product code** in this TZ. One page only: `/supply-requests`.
...
**Note:** SupplyRequest journal

---

## ЧТО ДЕЛАТЬ

1. Открой код страницы `/supply-requests` (не по памяти). При живом стенде — глазом UI.
2. Пройди чеклист T1–C1 из `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`.
3. Сравни с `/registries` expand + `pi-button` toolbar.
4. Напиши `docs/audits/2026-09-09-nx-ux-supply-requests-audit.md`:
...
5. Обнови WAVE row 07 audit status. Archive. **Не** правь product code.
