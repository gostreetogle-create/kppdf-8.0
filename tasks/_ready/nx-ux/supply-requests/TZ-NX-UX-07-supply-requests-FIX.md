# TZ-NX-UX-07-supply-requests-FIX: UX parity — `/supply-requests`

**РОЛЬ АГЕНТА:** Executor (frontend-nx) — claude  
**ЗАВИСИМОСТИ:** `TZ-NX-UX-07-supply-requests-AUDIT` DONE + verdict PASS-FIX (если PASS-EMPTY — skip, archive N/A)  
**LAYER:** 3 · **SIZE:** L  
**PAGES:** `/supply-requests`  
**PAGE_DOCS:** `supply.page.md`

**CONFLICT KEYS:**  
`frontend-nx/apps/kppdf-web/src/app/pages/supply/**supply-request**` ;  
`docs/pages/` relevant page.md ;  
`docs/audits/2026-09-09-nx-ux-supply-requests-audit.md` (closeout) ;  
...
- **Context read:** page audit `2026-09-09-nx-ux-supply-requests-audit.md`; canon sweep; registries gold
...
5. page.md NX UX note; WAVE row 07 FIX DONE; `_NOW` Claude IDLE.
