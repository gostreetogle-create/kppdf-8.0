# TZ-NX-UX-05-shipping-FIX: UX parity — `/shipping`

**РОЛЬ АГЕНТА:** Executor (frontend-nx) — claude  
**ЗАВИСИМОСТИ:** `TZ-NX-UX-05-shipping-AUDIT` DONE + verdict PASS-FIX (если PASS-EMPTY — skip, archive N/A)  
**LAYER:** 3 · **SIZE:** L  
**PAGES:** `/shipping`  
**PAGE_DOCS:** `shipping.page.md`

**CONFLICT KEYS:**  
`frontend-nx/apps/kppdf-web/src/app/pages/shipping/**` ;  
`docs/pages/` relevant page.md ;  
`docs/audits/2026-09-09-nx-ux-shipping-audit.md` (closeout) ;  
...
- **Context read:** page audit `2026-09-09-nx-ux-shipping-audit.md`; canon sweep; registries gold
...
5. page.md NX UX note; WAVE row 05 FIX DONE; `_NOW` Claude IDLE.
