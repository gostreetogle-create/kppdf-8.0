# TZ-NX-UX-04-orders-AUDIT: UX smell audit — `/orders`
...
**CONFLICT KEYS:**  
`docs/audits/2026-09-09-nx-ux-orders-audit.md` (create) ;  
`docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md` (row 04)

### Preflight Check Output
- **Context read:** `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`; registry gold `registry-detail-panel.component.ts`; page sources under `frontend-nx/.../pages/orders/orders-list.page.ts; pages/orders/order-hub-tray.component.ts`
- **Key Constraints:** **NO product code** in this TZ. One page only: `/orders`.
...
**Note:** List + hub tray tables/actions

---

## ЧТО ДЕЛАТЬ

1. Открой код страницы `/orders` (не по памяти). При живом стенде — глазом UI.
2. Пройди чеклист T1–C1 из `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`.
3. Сравни с `/registries` expand + `pi-button` toolbar.
4. Напиши `docs/audits/2026-09-09-nx-ux-orders-audit.md`:
...
5. Обнови WAVE row 04 audit status. Archive. **Не** правь product code.
