# TZ-NX-UX-04-orders-FIX: UX parity — `/orders`

**РОЛЬ АГЕНТА:** Executor (frontend-nx) — claude  
**ЗАВИСИМОСТИ:** `TZ-NX-UX-04-orders-AUDIT` DONE + verdict PASS-FIX (если PASS-EMPTY — skip, archive N/A)  
**LAYER:** 3 · **SIZE:** L  
**PAGES:** `/orders`  
**PAGE_DOCS:** `orders.page.md`

**CONFLICT KEYS:**  
`frontend-nx/apps/kppdf-web/src/app/pages/orders/orders-list.page.ts; pages/orders/order-hub-tray.component.ts` ;  
`docs/pages/` relevant page.md ;  
`docs/audits/2026-09-09-nx-ux-orders-audit.md` (closeout) ;  
...
- **Context read:** page audit `2026-09-09-nx-ux-orders-audit.md`; canon sweep; registries gold
...
5. page.md NX UX note; WAVE row 04 FIX DONE; `_NOW` Claude IDLE.
