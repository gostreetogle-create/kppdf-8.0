# TZ-NX-UX-09-storage-items-FIX: UX parity — `/storage-items`

**РОЛЬ АГЕНТА:** Executor (frontend-nx) — claude  
**ЗАВИСИМОСТИ:** `TZ-NX-UX-09-storage-items-AUDIT` DONE + verdict PASS-FIX (если PASS-EMPTY — skip, archive N/A)  
**LAYER:** 3 · **SIZE:** L  
**PAGES:** `/storage-items`  
...
`docs/audits/2026-09-09-nx-ux-storage-items-audit.md` (closeout) ;  
...
- **Context read:** page audit `2026-09-09-nx-ux-storage-items-audit.md`; canon sweep; registries gold
...
5. page.md NX UX note; WAVE row 09 FIX DONE; `_NOW` Claude IDLE.
