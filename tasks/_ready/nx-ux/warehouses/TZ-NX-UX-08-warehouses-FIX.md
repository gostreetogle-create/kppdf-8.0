# TZ-NX-UX-08-warehouses-FIX: UX parity — `/warehouses`

**РОЛЬ АГЕНТА:** Executor (frontend-nx) — claude  
**ЗАВИСИМОСТИ:** `TZ-NX-UX-08-warehouses-AUDIT` DONE + verdict PASS-FIX (если PASS-EMPTY — skip, archive N/A)  
**LAYER:** 3 · **SIZE:** L  
**PAGES:** `/warehouses`  
...
`docs/audits/2026-09-09-nx-ux-warehouses-audit.md` (closeout) ;  
...
- **Context read:** page audit `2026-09-09-nx-ux-warehouses-audit.md`; canon sweep; registries gold
...
5. page.md NX UX note; WAVE row 08 FIX DONE; `_NOW` Claude IDLE.
