# TZ-NX-UX-03-registries-FIX: UX parity — `/registries`

**РОЛЬ АГЕНТА:** Executor (frontend-nx) — claude  
**ЗАВИСИМОСТИ:** `TZ-NX-UX-03-registries-AUDIT` DONE + verdict PASS-FIX (если PASS-EMPTY — skip, archive N/A)  
**LAYER:** 3 · **SIZE:** L  
**PAGES:** `/registries`  
...
`docs/audits/2026-09-09-nx-ux-registries-audit.md` (closeout) ;  
...
- **Context read:** page audit `2026-09-09-nx-ux-registries-audit.md`; canon sweep; registries gold
...
5. page.md NX UX note; WAVE row 03 FIX DONE; `_NOW` Claude IDLE.
