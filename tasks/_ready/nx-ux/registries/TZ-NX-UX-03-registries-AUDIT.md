# TZ-NX-UX-03-registries-AUDIT: UX smell audit — `/registries`

**РОЛЬ АГЕНТА:** Executor auditor — claude  
**ЗАВИСИМОСТИ:** предыдущая волна UX закрыта (или первая)  
**LAYER:** 4 (docs) · **SIZE:** S  
**PAGES:** `/registries`  
**PAGE_DOCS:** `(registries)`

**CONFLICT KEYS:**  
`docs/audits/2026-09-09-nx-ux-registries-audit.md` (create) ;  
`docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md` (row 03)

### Preflight Check Output
- **Context read:** `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`; registry gold `registry-detail-panel.component.ts`; page sources under `frontend-nx/.../pages/registries/**`
- **Key Constraints:** **NO product code** in this TZ. One page only: `/registries`.
...
**Note:** GOLD verify — polish only if smell

---

## ЧТО ДЕЛАТЬ

1. Открой код страницы `/registries` (не по памяти). При живом стенде — глазом UI.
2. Пройди чеклист T1–C1 из `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`.
3. Сравни с `/registries` expand + `pi-button` toolbar.
4. Напиши `docs/audits/2026-09-09-nx-ux-registries-audit.md`:
...
5. Обнови WAVE row 03 audit status. Archive. **Не** правь product code.
