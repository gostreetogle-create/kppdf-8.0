# TZ-NX-UX-06-supply-AUDIT: UX smell audit — `/supply`
...
**CONFLICT KEYS:**  
`docs/audits/2026-09-09-nx-ux-supply-audit.md` (create) ;  
`docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md` (row 06)

### Preflight Check Output
- **Context read:** `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`; registry gold `registry-detail-panel.component.ts`; page sources under `frontend-nx/.../pages/supply/supply.page.ts`
- **Key Constraints:** **NO product code** in this TZ. One page only: `/supply`.
...
**Note:** By-order supply registry

---

## ЧТО ДЕЛАТЬ

1. Открой код страницы `/supply` (не по памяти). При живом стенде — глазом UI.
2. Пройди чеклист T1–C1 из `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`.
3. Сравни с `/registries` expand + `pi-button` toolbar.
4. Напиши `docs/audits/2026-09-09-nx-ux-supply-audit.md`:
...
5. Обнови WAVE row 06 audit status. Archive. **Не** правь product code.
