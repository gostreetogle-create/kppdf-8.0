# TZ-NX-UX-06-supply-FIX: UX parity — `/supply`

**РОЛЬ АГЕНТА:** Executor (frontend-nx) — claude  
**ЗАВИСИМОСТИ:** `TZ-NX-UX-06-supply-AUDIT` DONE + verdict PASS-FIX (если PASS-EMPTY — skip, archive N/A)  
**LAYER:** 3 · **SIZE:** L  
**PAGES:** `/supply`  
...
`docs/audits/2026-09-09-nx-ux-supply-audit.md` (closeout) ;  
...
- **Context read:** page audit `2026-09-09-nx-ux-supply-audit.md`; canon sweep; registries gold
...
5. page.md NX UX note; WAVE row 06 FIX DONE; `_NOW` Claude IDLE.
