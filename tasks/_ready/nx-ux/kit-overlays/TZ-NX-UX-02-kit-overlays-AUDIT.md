# TZ-NX-UX-02-kit-overlays-AUDIT: UX smell audit — `/kit/overlays`

**РОЛЬ АГЕНТА:** Executor auditor — claude  
**ЗАВИСИМОСТИ:** предыдущая волна UX закрыта (или первая)  
**LAYER:** 4 (docs) · **SIZE:** S  
**PAGES:** `/kit/overlays`  
**PAGE_DOCS:** `ui-dialog-canon.md`

**CONFLICT KEYS:**  
`docs/audits/2026-09-09-nx-ux-kit-overlays-audit.md` (create) ;  
`docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md` (row 02)

### Preflight Check Output
- **Context read:** `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`; registry gold `registry-detail-panel.component.ts`; page sources under `frontend-nx/.../pages/kit/**; pages overlays`
- **Key Constraints:** **NO product code** in this TZ. One page only: `/kit/overlays`.
...
**Note:** Dialogs overlays cookbook

---

## ЧТО ДЕЛАТЬ

1. Открой код страницы `/kit/overlays` (не по памяти). При живом стенде — глазом UI.
2. Пройди чеклист T1–C1 из `docs/audits/2026-09-09-nx-ux-page-sweep-canon.md`.
3. Сравни с `/registries` expand + `pi-button` toolbar.
4. Напиши `docs/audits/2026-09-09-nx-ux-kit-overlays-audit.md`:
...
5. Обнови WAVE row 02 audit status. Archive. **Не** правь product code.
