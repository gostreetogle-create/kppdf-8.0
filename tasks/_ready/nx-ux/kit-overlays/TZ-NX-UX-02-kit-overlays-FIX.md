# TZ-NX-UX-02-kit-overlays-FIX: UX parity — `/kit/overlays`

**РОЛЬ АГЕНТА:** Executor (frontend-nx) — claude  
**ЗАВИСИМОСТИ:** `TZ-NX-UX-02-kit-overlays-AUDIT` DONE + verdict PASS-FIX (если PASS-EMPTY — skip, archive N/A)  
**LAYER:** 3 · **SIZE:** L  
**PAGES:** `/kit/overlays`  
**PAGE_DOCS:** `ui-dialog-canon.md`

**CONFLICT KEYS:**  
`frontend-nx/apps/kppdf-web/src/app/pages/kit/**; pages overlays` ;  
`docs/pages/` relevant page.md ;  
`docs/audits/2026-09-09-nx-ux-kit-overlays-audit.md` (closeout) ;  
...
- **Context read:** page audit `2026-09-09-nx-ux-kit-overlays-audit.md`; canon sweep; registries gold
...
5. page.md NX UX note; WAVE row 02 FIX DONE; `_NOW` Claude IDLE.
