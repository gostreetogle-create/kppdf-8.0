# PROMPT — Claude UX wave 01: `/kit/forms`
...
WAVE: docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md (только строка 01 / kit-forms)
Canon: docs/audits/2026-09-09-nx-ux-page-sweep-canon.md
Эталон: /registries expand + pi-button; /kit primitives.
Страница: /kit/forms — Form primitives parity

═══ ОЧЕРЕДЬ ═══
0) tasks/_ready/nx-ux/kit-forms/TZ-NX-UX-01-kit-forms-AUDIT.md
   ТОЛЬКО аудит. Код запрещён. Файл docs/audits/2026-09-09-nx-ux-kit-forms-audit.md
   Verdict PASS-EMPTY или PASS-FIX.

1) Если PASS-FIX: tasks/_ready/nx-ux/kit-forms/TZ-NX-UX-01-kit-forms-FIX.md
