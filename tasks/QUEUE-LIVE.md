...
|---|--------|------|-----------------|
| 1 | `TZ-NX-DOCSTUDIO-S0-FOUNDATION` — **код готов, не закрыт**: гейты, браузер, page.md, архив | Freebuff | `PROMPT-FREEBUFF-DOCSTUDIO-S0-CLOSEOUT.md` · упёрлось в чужой пустой spec-хелпер |
