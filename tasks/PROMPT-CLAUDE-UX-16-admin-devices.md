# PROMPT — Claude UX wave 16: `/admin/devices`
...
WAVE: docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md (только строка 16 / admin-devices)
Canon: docs/audits/2026-09-09-nx-ux-page-sweep-canon.md
Эталон: /registries expand + pi-button; /kit primitives.
Страница: /admin/devices — Devices admin table

═══ ОЧЕРЕДЬ ═══
0) tasks/_ready/nx-ux/admin-devices/TZ-NX-UX-16-admin-devices-AUDIT.md
   ТОЛЬКО аудит. Код запрещён. Файл docs/audits/2026-09-09-nx-ux-admin-devices-audit.md
   Verdict PASS-EMPTY или PASS-FIX.

1) Если PASS-FIX: tasks/_ready/nx-ux/admin-devices/TZ-NX-UX-16-admin-devices-FIX.md
