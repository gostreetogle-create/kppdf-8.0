# PROMPT — Claude UX wave 13: `/counterparties`
...
WAVE: docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md (только строка 13 / counterparties)
Canon: docs/audits/2026-09-09-nx-ux-page-sweep-canon.md
Эталон: /registries expand + pi-button; /kit primitives.
Страница: /counterparties — Clients list

═══ ОЧЕРЕДЬ ═══
0) tasks/_ready/nx-ux/counterparties/TZ-NX-UX-13-counterparties-AUDIT.md
   ТОЛЬКО аудит. Код запрещён. Файл docs/audits/2026-09-09-nx-ux-counterparties-audit.md
   Verdict PASS-EMPTY или PASS-FIX.

1) Если PASS-FIX: tasks/_ready/nx-ux/counterparties/TZ-NX-UX-13-counterparties-FIX.md
