# PROMPT — Claude UX wave 17: `/admin/roles`
...
WAVE: docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md (только строка 17 / admin-roles)
Canon: docs/audits/2026-09-09-nx-ux-page-sweep-canon.md
Эталон: /registries expand + pi-button; /kit primitives.
Страница: /admin/roles — Roles admin

═══ ОЧЕРЕДЬ ═══
0) tasks/_ready/nx-ux/admin-roles/TZ-NX-UX-17-admin-roles-AUDIT.md
   ТОЛЬКО аудит. Код запрещён. Файл docs/audits/2026-09-09-nx-ux-admin-roles-audit.md
   Verdict PASS-EMPTY или PASS-FIX.

1) Если PASS-FIX: tasks/_ready/nx-ux/admin-roles/TZ-NX-UX-17-admin-roles-FIX.md
