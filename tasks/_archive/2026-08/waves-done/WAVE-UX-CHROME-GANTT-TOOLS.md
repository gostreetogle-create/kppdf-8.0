...
## Queue (строго по порядку)

| # | TZ | Points |
|---|-----|-------:|
| 1 | `tasks/TZ-UX-322-chrome-page-tools-api.md` | 40 |
| 2 | `tasks/TZ-UX-323-gantt-tools-into-chrome-rail.md` | 60 |
| | **PASS** | **100** |
...
Backend, estimate math, modules filter, deploy unless PO says деплой.
