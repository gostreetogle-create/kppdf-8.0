...
---
## CLOSEOUT (cursor-executor, 2026-08-23T23:20+03:00)

- Autofill: select > fields from `suppliers()`; sparse/missing live ObjectId > `findById` merge.
- Persist: local on input; Organization/Person PATCH on blur + 500ms debounce; empty > omit; fail > error + revert; success > ���������� 1.5s.
- Gates: `pnpm test -- src/app/pages/supply/supply-quick-order.component.spec.ts` > 37/37 PASS.
- Uncommitted (peer WIP on same files from 316 + other trees). Deploy ��.
