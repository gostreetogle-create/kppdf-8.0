# PROMPT — Claude UX wave 02: `/kit/overlays`
...
WAVE: docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md (только строка 02 / kit-overlays)
Canon: docs/audits/2026-09-09-nx-ux-page-sweep-canon.md
Эталон: /registries expand + pi-button; /kit primitives.
Страница: /kit/overlays — Dialogs overlays cookbook

═══ ОЧЕРЕДЬ ═══
0) tasks/_ready/nx-ux/kit-overlays/TZ-NX-UX-02-kit-overlays-AUDIT.md
   ТОЛЬКО аудит. Код запрещён. Файл docs/audits/2026-09-09-nx-ux-kit-overlays-audit.md
   Verdict PASS-EMPTY или PASS-FIX.

1) Если PASS-FIX: tasks/_ready/nx-ux/kit-overlays/TZ-NX-UX-02-kit-overlays-FIX.md
