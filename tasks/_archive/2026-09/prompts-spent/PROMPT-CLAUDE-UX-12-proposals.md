# PROMPT — Claude UX wave 12: `/proposals`
...
WAVE: docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md (только строка 12 / proposals)
Canon: docs/audits/2026-09-09-nx-ux-page-sweep-canon.md
Эталон: /registries expand + pi-button; /kit primitives.
Страница: /proposals — KP list table

═══ ОЧЕРЕДЬ ═══
0) tasks/_ready/nx-ux/proposals/TZ-NX-UX-12-proposals-AUDIT.md
   ТОЛЬКО аудит. Код запрещён. Файл docs/audits/2026-09-09-nx-ux-proposals-audit.md
   Verdict PASS-EMPTY или PASS-FIX.

1) Если PASS-FIX: tasks/_ready/nx-ux/proposals/TZ-NX-UX-12-proposals-FIX.md
