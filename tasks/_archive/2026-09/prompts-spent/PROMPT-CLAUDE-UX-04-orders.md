# PROMPT — Claude UX wave 04: `/orders`
...
WAVE: docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md (только строка 04 / orders)
Canon: docs/audits/2026-09-09-nx-ux-page-sweep-canon.md
Эталон: /registries expand + pi-button; /kit primitives.
Страница: /orders — List + hub tray tables/actions

═══ ОЧЕРЕДЬ ═══
0) tasks/_ready/nx-ux/orders/TZ-NX-UX-04-orders-AUDIT.md
   ТОЛЬКО аудит. Код запрещён. Файл docs/audits/2026-09-09-nx-ux-orders-audit.md
   Verdict PASS-EMPTY или PASS-FIX.

1) Если PASS-FIX: tasks/_ready/nx-ux/orders/TZ-NX-UX-04-orders-FIX.md
