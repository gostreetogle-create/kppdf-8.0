# PROMPT — Claude UX wave 03: `/registries`
...
WAVE: docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md (только строка 03 / registries)
Canon: docs/audits/2026-09-09-nx-ux-page-sweep-canon.md
Эталон: /registries expand + pi-button; /kit primitives.
Страница: /registries — GOLD verify — polish only if smell

═══ ОЧЕРЕДЬ ═══
0) tasks/_ready/nx-ux/registries/TZ-NX-UX-03-registries-AUDIT.md
   ТОЛЬКО аудит. Код запрещён. Файл docs/audits/2026-09-09-nx-ux-registries-audit.md
   Verdict PASS-EMPTY или PASS-FIX.

1) Если PASS-FIX: tasks/_ready/nx-ux/registries/TZ-NX-UX-03-registries-FIX.md
