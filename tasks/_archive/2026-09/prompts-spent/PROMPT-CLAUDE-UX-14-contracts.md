# PROMPT — Claude UX wave 14: `/contracts`
...
WAVE: docs/agent-checklists/WAVE-NX-UX-PAGE-SWEEP.md (только строка 14 / contracts)
Canon: docs/audits/2026-09-09-nx-ux-page-sweep-canon.md
Эталон: /registries expand + pi-button; /kit primitives.
Страница: /contracts — Contracts list+detail thin

═══ ОЧЕРЕДЬ ═══
0) tasks/_ready/nx-ux/contracts/TZ-NX-UX-14-contracts-AUDIT.md
   ТОЛЬКО аудит. Код запрещён. Файл docs/audits/2026-09-09-nx-ux-contracts-audit.md
   Verdict PASS-EMPTY или PASS-FIX.

1) Если PASS-FIX: tasks/_ready/nx-ux/contracts/TZ-NX-UX-14-contracts-FIX.md
