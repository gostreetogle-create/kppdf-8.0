...
3) Бери первый незакрытый не-PARKED TZ по порядку волны: 310 → 311 → 312; **313** можно после 310 параллельно только если CONFLICT KEYS свободны (не трогать create-page keys 312/314…).
