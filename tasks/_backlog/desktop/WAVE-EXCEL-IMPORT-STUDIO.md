...
- Вкладки Импорт Excel | MCP; большая таблица; drop Excel → статусы строк → Отправить в SoT (flat как минимум).
- Дубли/коллизии видны до отправки; опц. AI-check при живом MCP.
