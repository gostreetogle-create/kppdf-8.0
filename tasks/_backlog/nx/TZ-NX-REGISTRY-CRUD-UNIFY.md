...
СТАТУС: **BACKLOG** — выдавать по команде PO, не в текущей волне
ЗАВИСИМОСТИ: `TZ-NX-DOCSTUDIO-S0-FOUNDATION` (добавляет реестры «Тексты» и «Виды таблиц» — их тоже причесать этой волной)
