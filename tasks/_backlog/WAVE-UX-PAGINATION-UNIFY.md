...
| 2 | TZ-UX-341 | `tasks/_archive/2026-08/TZ-UX-341.done.md` | 340; желательно после UX-326 (оба `products.page`) | **DONE** (`c1e5d1c5`) |
| 3 | TZ-UX-342 | `tasks/_archive/2026-08/TZ-UX-342.done.md` | 340 | **DONE** (`db689987`) |
