...
| Frontend layout | `frontend/src/app/layout/` | AppLayout (operational), KitLayout (UI showcase). **TZ-NAV-301:** top nav L→R = lifecycle (Справочники→…→Админ); stubs `/counterparties` `/design` `/supply` `/shipping`. |
