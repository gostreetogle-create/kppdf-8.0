/**
 * TZD-72 — NX port of `frontend/src/app/pages/desktop/pairing-dialog.component.spec.ts`.
...
describe('PairingDialogComponent (TZD-72 NX port)', () => {
  ...
  async function setupModule(desktopUrl: string): Promise<void> {
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        {
          provide: PiDesktopPairingService,
