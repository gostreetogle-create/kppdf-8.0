...
import { silentGet, silentPatch, SilentResult } from '@kppdf/util-http';
interface ToastLike {
  warning(message: string): string;
}

export const PI_TOAST = new InjectionToken<ToastLike>('PI_TOAST');
...
export class PiDictionaryLabelsService {
  ...
  private readonly toast = inject(PI_TOAST, { optional: true });
