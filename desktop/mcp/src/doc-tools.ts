  ...
  server.registerTool(
    ...
    async () => {
      try {
        ...
        return toolFail('kppdf_doc_types_list', err);
      }
    },
  );
  ...
  server.registerTool(
    ...
    async () => {
      try {
        ...
        return toolFail('kppdf_doc_template_categories_list', err);
      }
    },
  );
  ...
  server.registerTool(
    ...
    async () => {
      try {
        ...
        return toolFail('kppdf_doc_templates_list', err);
      }
    },
  );
  ...
  server.registerTool(
    'kppdf_doc_template_create_draft',
    {
      ...
      inputSchema: {
        ...
        docTypeId: z.string().min(1).describe('Doc type id (see kppdf_doc_types_list)'),
